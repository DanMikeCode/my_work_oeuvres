...
const price = require('./price-f9faf5f1.js');
const media = require('./media-71bcf49e.js');
const mutations$1 = require('./mutations-ae7c6b7a.js');
const index$3 = require('./index-f7a328b1.js');
const getters = require('./getters-32a95db1.js');
...
const ScOrderTaxIdInput = class {
  ...
  render() {
    var _a, _b, _c, _d, _e, _f;
    return (index.h("sc-tax-id-input", { ref: el => (this.input = el), show: this.show, number: (_b = (_a = mutations.state.checkout) === null || _a === void 0 ? void 0 : _a.tax_identifier) === null || _b === void 0 ? void 0 : _b.number, type: (_d = (_c = mutations.state.checkout) === null || _c === void 0 ? void 0 : _c.tax_identifier) === null || _d === void 0 ? void 0 : _d.number_type, country: (_f = (_e = mutations.state.checkout) === null || _e === void 0 ? void 0 : _e.shipping_address) === null || _f === void 0 ? void 0 : _f.country, status: this.getStatus(), loading: getters$1.formBusy(), onScChange: e => {
        e.stopImmediatePropagation();
