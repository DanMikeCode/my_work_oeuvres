...
const index$1 = require('./index-f7a328b1.js');
...
const mutations$3 = require('./mutations-ae7c6b7a.js');
...
const getters$2 = require('./getters-1ec0572e.js');
  ...
  async confirmOrder() {
    ...
    try {
      ...
      if (successUrl) {
        ...
        setTimeout(() => { var _a; return window.location.assign(addQueryArgs.addQueryArgs(successUrl, { sc_order: (_a = mutations.state.checkout) === null || _a === void 0 ? void 0 : _a.id })); }, 50);
      }
      else {
...
const ScSessionProvider = class {
  ...
  async handleErrorResponse(e) {
    ...
    if (['checkout.not_found'].includes(e === null || e === void 0 ? void 0 : e.code)) {
      window.history.replaceState({}, document.title, mutations.removeQueryArgs(window.location.href, 'checkout_id'));
      mutations$3.clearCheckout();
    ...
    if (((e === null || e === void 0 ? void 0 : e.additional_errors) || []).some(error => (error === null || error === void 0 ? void 0 : error.code) == 'checkout.price.old_version')) {
      ...
      mutations$2.createInfoNotice(wp.i18n.__('The price a product in your order has changed. We have adjusted your order to the new price.', 'surecart'));
      return;
    }
    ...
    if (['order.invalid_status_transition'].includes(e === null || e === void 0 ? void 0 : e.code)) {
      await this.loadUpdate({
        id: (_d = mutations.state === null || mutations.state === void 0 ? void 0 : mutations.state.checkout) === null || _d === void 0 ? void 0 : _d.id,
        data: {
          status: 'draft',
        },
      });
