...
import { s as state, o as onChange, r as removeQueryArgs } from './mutations-de1b4429.js';
import { d as updateCheckout, e as expand, f as finalizeCheckout, g as fetchCheckout, c as createOrUpdateCheckout } from './index-39b714d4.js';
import { c as currentFormState } from './getters-2c9ecd8c.js';
import { s as shippingAddressRequired } from './getters-4160b3dd.js';
...
import { c as clearCheckout } from './mutations-ccac0bc6.js';
...
import { s as state$3 } from './getters-259fef92.js';
  ...
  async confirmOrder() {
    ...
    try {
      ...
      if (successUrl) {
        ...
        setTimeout(() => { var _a; return window.location.assign(addQueryArgs(successUrl, { sc_order: (_a = state.checkout) === null || _a === void 0 ? void 0 : _a.id })); }, 50);
      }
      else {
...
const ScSessionProvider = class {
  ...
  async handleErrorResponse(e) {
    ...
    if (((e === null || e === void 0 ? void 0 : e.additional_errors) || []).some(error => (error === null || error === void 0 ? void 0 : error.code) == 'checkout.price.old_version')) {
      ...
      createInfoNotice(wp.i18n.__('The price a product in your order has changed. We have adjusted your order to the new price.', 'surecart'));
      return;
    }
    ...
    if (['order.invalid_status_transition'].includes(e === null || e === void 0 ? void 0 : e.code)) {
      await this.loadUpdate({
        id: (_d = state === null || state === void 0 ? void 0 : state.checkout) === null || _d === void 0 ? void 0 : _d.id,
        data: {
          status: 'draft',
        },
      });
